                        ...
                        <div className="cont">
                            ...
                            {showIcons && (
                                <div className="social d-flex gap-3 pt-4">
                                    ...
                                    <a href="https://twitter.com/uCr0w_" rel="noopener noreferrer"  target="_blank"> 
                                        <i className="fab fa-twitter"></i>
                                    </a>
                                    <a href="#0" >
                                        <i className="fab fa-github"></i>
                                    </a>
                                    <a href="https://www.linkedin.com/in/camil-arslan/" rel="noopener noreferrer" target="_blank">
